...
namespace RBOS {
    ...
    public class SalesStatRpt : ReportClass {
    ...
    public class CachedSalesStatRpt : Component, ICachedReport {
        
        public CachedSalesStatRpt() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SalesStatRpt rpt = new SalesStatRpt();
            rpt.Site = this.Site;
            return rpt;
        }
